...
export declare class HttpError extends Error {
    status: StatusCode;
    code: string;
    constructor(status: StatusCode, code: string, message: string);
}
export declare function isHttpError(err: unknown): err is HttpError;
export declare function httpError(c: Context, status: StatusCode, code: string, message: string): Response & import("hono").TypedResponse<{
    error: {
        code: string;
        message: string;
    };
